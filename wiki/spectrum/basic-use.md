...
## Controls
```admonish warning
NOTE: With the release of Arma v2.22, The control scheme has moved away from using middle-mouse click-button for zoom. Instead the controls described below is the only way and should likely feel more intuitive.
```
